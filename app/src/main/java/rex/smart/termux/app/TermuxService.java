...
import rex.smart.termux.app.event.SystemEventReceiver;
import rex.smart.termux.app.terminal.TermuxTerminalSessionActivityClient;
import rex.smart.termux.app.terminal.TermuxTerminalSessionServiceClient;
import rex.smart.termux.shared.termux.plugins.TermuxPluginUtils;
import rex.smart.termux.shared.data.IntentUtils;
import rex.smart.termux.shared.net.uri.UriUtils;
import rex.smart.termux.shared.errors.Errno;
import rex.smart.termux.shared.shell.ShellUtils;
import rex.smart.termux.shared.shell.command.runner.app.AppShell;
import rex.smart.termux.shared.termux.settings.properties.TermuxAppSharedProperties;
import rex.smart.termux.shared.termux.shell.command.environment.TermuxShellEnvironment;
import rex.smart.termux.shared.termux.shell.TermuxShellUtils;
...
import rex.smart.termux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import rex.smart.termux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import rex.smart.termux.shared.termux.shell.TermuxShellManager;
import rex.smart.termux.shared.termux.shell.command.runner.terminal.TermuxSession;
import rex.smart.termux.shared.termux.terminal.TermuxTerminalSessionClientBase;
import rex.smart.termux.shared.logger.Logger;
import rex.smart.termux.shared.notification.NotificationUtils;
...
import rex.smart.termux.shared.shell.command.ExecutionCommand.ShellCreateMode;
import rex.smart.termux.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(rex.smart.termux.shared.R.string.error_execution_cancelled))) {
