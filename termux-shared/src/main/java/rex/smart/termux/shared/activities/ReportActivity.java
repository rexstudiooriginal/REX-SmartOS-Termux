package rex.smart.termux.shared.activities;
...
import rex.smart.termux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="rex.smart.termux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="rex.smart.termux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
