package rex.smart.termux.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/rex.smart.termux.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx rex.smart.termux/10xxx}
             */
