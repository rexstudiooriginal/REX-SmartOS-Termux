...
import rex.smart.termux.shared.reflection.ReflectionUtils;
...
import rex.smart.termux.shared.android.PackageUtils;
import rex.smart.termux.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `rex.smart.termux`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... rex.smart.termux/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="rex.smart.termux" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(rex.smart.termux.shared.R.raw.apt_info_script);
        try {
