package rex.smart.termux.shared.termux.file;
...
import rex.smart.termux.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/rex.smart.termux` as secondary user will result
     * in `ls: /data/user/0/rex.smart.termux: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/rex.smart.termux` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/rex.smart.termux` where `10` is
